...
/// Screen for editing skills the user wants to learn
class EditSkillsWantedScreen extends ConsumerWidget {
  const EditSkillsWantedScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final userAsync = ref.watch(currentUserProfileProvider);
    final editState = ref.watch(editSkillsWantedNotifierProvider);
    ...
    userAsync.whenData((user) {
      if (user != null && !editState.isInitialized) {
        ...
        Future.microtask(() {
          ref
              .read(editSkillsWantedNotifierProvider.notifier)
              .initialize(user.skillsWanted);
        });
      }
    });
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        ...
        if (shouldPop && context.mounted) {
          ref.read(editSkillsWantedNotifierProvider.notifier).reset();
          context.pop();
        }
      },
      child: Scaffold(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Discover skills from the community. You need at least one skill.',
                  style: TextStyle(
                    fontSize: 14,
  ...
  Future<void> _saveChanges(BuildContext context, WidgetRef ref) async {
    ...
    if (success) {
      ...
      final errorMessage = ref.read(editSkillsWantedNotifierProvider).errorMessage;
  ...
  Widget _buildSkillsList(
    BuildContext context,
    WidgetRef ref,
    EditSkillsWantedState editState,
    AsyncValue<List<dynamic>> categoriesAsync,
  ) {
    return Column(
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                '${editState.skills.length} skill${editState.skills.length > 1 ? 's' : ''} to learn',
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          color: AppColors.secondaryTeal.withOpacity(0.04),
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
  ...
  void _showAddSkillDialog(
    ...
    showModalBottomSheet(
      ...
      builder: (context) => AddSkillWantedDialog(
        ...
        onAdd: (skill) {
          ref.read(editSkillsWantedNotifierProvider.notifier).addSkill(skill);
